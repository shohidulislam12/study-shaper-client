...
const HowWork = () => {
  return (
    <section className="py-16 dark:bg-black  bg-[#fbf6f6]">
      <div className="container mx-auto px-4">
      <h2 className="text-3xl font-bold text-center dark:text-white  text-indigo-700 mb-8">
      How It Works
                </h2>
        <p className="text-lg dark:text-white text-gray-600 text-center mb-12">
        ...
        <div className="relative">
          ...
          <div className="flex flex-col md:flex-row items-center mb-12">
            <div className="w-full md:w-1/2 md:pr-8 dark:text-white  text-right mb-4 md:mb-0">
          ...
          <div className="flex flex-col md:flex-row items-center mb-12">
            ...
            <div className="w-full md:w-1/2 md:pl-8 text-left mb-4 md:mb-0 order-1 md:order-2">
              <h3 className="text-2xl font-bold dark:text-white  mb-2">Step 2: Explore Session</h3>
              <p className="text-gray-600 dark:text-white">
          ...
          <div className="flex flex-col md:flex-row items-center mb-12">
            <div className="w-full md:w-1/2 md:pr-8 text-right mb-4 md:mb-0">
              <h3 className="text-2xl font-bold dark:text-white  mb-2">Step 3: Manage Your DashBord</h3>
              <p className="text-gray-600 dark:text-white ">
            ...
            <div className="w-full md:w-1/2 md:pl-8">
              <div className="bg-white p-6 rounded-lg shadow-lg">
                <img
                  src="https://i.ibb.co.com/RG5jWY0b/Screenshot-2025-02-19-131105.png"
                  alt="Customize Plan"
                  className="w-full h-auto rounded-md"
                />
              </div>
